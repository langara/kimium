...
/*
TODO NOW: hardcode my search engines in some nicer way?
...
ix: https://x.com/i/grok?text=%s Grok XAi
ic: https://chatgpt.com/?q=%s&hints=search ChatGPT
go: http://www.google.com/search?q=%s Google
gl: http://www.google.com/search?q=%s&btnI I'm feeling lucky...
tre: https://translate.google.pl/?sl=en&tl=pl&text=%s Translate EN->PL
trp: https://translate.google.pl/?sl=pl&tl=en&text=%s Translate PL->EN
acs: https://cs.android.com/search?q=%s&ss=androidx%2Fplatform%2Fframeworks%2Fsupport
tw: https://twitter.com/search?q=%s
all: http://www.allegro.pl/search.php?string=%s
ad: https://developer.android.com/s/results?q=%s
pwn: https://encyklopedia.pwn.pl/szukaj/%s.html
fb: https://www.facebook.com/search/top/?q=%s&opensearch=1
...
wikie: https://en.wikipedia.org/wiki/Special:Search?search=%s Wikipedia (en)
wikip: http://pl.wikipedia.org/wiki/Specjalna:Szukaj?search=%s Wikipedia (pl)
wykop: https://wykop.pl/szukaj/wszystkie/%s Wykop.pl
yahoo: https://search.yahoo.com/search?p=%s Yahoo
ys: https://you.com/search?q=%s You.com
